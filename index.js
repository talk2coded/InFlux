!(function (t, e) {
    ...
    (function (t) {
        ...
        function i() {}
        function n() {
            for (var t = { width: 0, height: 0, innerWidth: 0, innerHeight: 0, outerWidth: 0, outerHeight: 0 }, e = 0, i = o.length; i > e; e++) {
                var n = o[e];
                t[n] = 0;
            }
            return t;
    ...
    (function (t) {
        ...
        function n(t, e) {
            i(t);
            for (var n = t.parentNode.querySelectorAll(e), r = 0, s = n.length; s > r; r++) if (n[r] === t) return !0;
            return !1;
        }
        function r(t, n) {
            return i(t), e(t, n);
    ...
    (function (t, e) {
        "function" == typeof define && define.amd
            ? define("outlayer/item", ["eventEmitter/EventEmitter", "get-size/get-size", "get-style-property/get-style-property", "fizzy-ui-utils/utils"], function (i, n, r, s) {
                  return e(t, i, n, r, s);
              })
            : "object" == typeof exports
        ...
        r.extend(o.prototype, e.prototype),
            ...
            (o.prototype.moveTo = f ? o.prototype._transitionTo : o.prototype.goTo),
    ...
    (function (t, e) {
        "function" == typeof define && define.amd
            ? define("outlayer/outlayer", ["eventie/eventie", "eventEmitter/EventEmitter", "get-size/get-size", "fizzy-ui-utils/utils", "./item"], function (i, n, r, s, o) {
        ...
        return (
            ...
            (o.prototype._getElementOffset = function (t) {
                var e = t.getBoundingClientRect(),
                    ...
                    r = n(t),
                    s = { left: e.left - i.left - r.marginLeft, top: e.top - i.top - r.marginTop, right: i.right - e.right - r.marginRight, bottom: i.bottom - e.bottom - r.marginBottom };
                return s;
            }),
            (o.prototype.handleEvent = function (t) {
                var e = "on" + t.type;
    ...
    (function (t, e) {
        ...
        return (
            ...
            (n.prototype._getItemLayoutPosition = function (t) {
                ...
                for (var s = this._getColGroup(r), o = Math.min.apply(Math, s), a = i.indexOf(s, o), l = { x: this.columnWidth * a, y: o }, h = o + t.size.outerHeight, u = this.cols + 1 - s.length, c = 0; u > c; c++) this.colYs[a + c] = h;
                return l;
            }),
        ...
        function (t, e, i) {
            ...
            (r.version = "1.15.1"),
                ...
                (h.render = function (t, e, i) {
                        ...
                        (t >= d
                            ? ((this._totalTime = d),
                              ...
                              0 === v &&
                                  ...
                                  (this._startTime === this._timeline._duration && (t = 0), (0 === t || 0 > y || y === s) && y !== t && ((i = !0), y > s && (r = "onReverseComplete")), (this._rawPrevTime = p = !e || t || y === t ? t : s)))
                            : 1e-7 > t
                            ? ((this._totalTime = this._time = this._cycle = 0),
                              (this.ratio = this._ease._calcEnd ? this._ease.getRatio(0) : 0),
                              (0 !== _ || (0 === v && y > 0 && y !== s)) && ((r = "onReverseComplete"), (n = this._reversed)),
                              0 > t && ((this._active = !1), 0 === v && (this._initted || !this.vars.lazy || i) && (y >= 0 && (i = !0), (this._rawPrevTime = p = !e || t || y === t ? t : s))),
                              this._initted || (i = !0))
                            : ((this._totalTime = this._time = t),
                              ...
                              this._easeType
                                  ? ((h = this._time / v),
                                    ...
                                    (this.ratio = 1 === c ? 1 - h : 2 === c ? h : 0.5 > this._time / v ? h / 2 : 1 - h / 2))
                    ...
                    this._onUpdate && (0 > t && this._startAt && this._startTime && this._startAt.render(t, e, i), e || ((this._totalTime !== _ || n) && this._onUpdate.apply(this.vars.onUpdateScope || this, this.vars.onUpdateParams || u))),
                ...
                (r.killChildTweensOf = function (t, e) {
                    if (null != t) {
                        ...
                        if (("string" == typeof t && (t = i.selector(t) || t), a(t) && (t = n(t)), l(t))) for (c = t.length; --c > -1; ) r.killChildTweensOf(t[c], e);
                            ...
                            s = [];
                            for (u in p) for (h = p[u].target.parentNode; h; ) h === t && (s = s.concat(p[u].tweens)), (h = h.parentNode);
            ...
            function (t, e, i) {
                ...
                return (
                    ...
                    (_.staggerTo = function (t, e, r, s, o, l, h, u) {
                        var c,
                            f = new n({ onComplete: l, onCompleteParams: h, onCompleteScope: u, smoothChildTiming: this.smoothChildTiming });
                        for ("string" == typeof t && (t = i.selector(t) || t), t = t || [], a(t) && (t = m(t)), s = s || 0, 0 > s && ((t = m(t)), t.reverse(), (s *= -1)), c = 0; t.length > c; c++)
                            r.startAt && (r.startAt = p(r.startAt)), f.to(t[c], e, p(r), c * s);
                        return this.add(f, o);
                    }),
                    ...
                    (_.add = function (r, s, o, a) {
                        ...
                        if (("number" != typeof s && (s = this._parseTimeOrLabel(s, 0, !0, r)), !(r instanceof t))) {
                            if (r instanceof Array || (r && r.push && l(r))) {
                                for (o = o || "normal", a = a || 0, h = s, u = r.length, c = 0; u > c; c++)
                        ...
                        if (
                            (t >= f
                                ...
                                ? ((this._totalTime = this._time = 0),
                                  (0 !== p || (0 === this._duration && this._rawPrevTime !== r && (this._rawPrevTime > 0 || (0 > t && this._rawPrevTime >= 0)))) && ((a = "onReverseComplete"), (s = this._reversed)),
                                  0 > t
                            ...
                            if (
                                ...
                                for (n = this._last; n && ((o = n._prev), !this._paused || _); )
                                    (n._active || (p >= n._startTime && !n._paused && !n._gc)) &&
                                        (n._reversed ? n.render((n._dirty ? n.totalDuration() : n._totalDuration) - (t - n._startTime) * n._timeScale, e, i) : n.render((t - n._startTime) * n._timeScale, e, i)),
                                        (n = o);
                            this._onUpdate && (e || (h.length && u(), this._onUpdate.apply(this.vars.onUpdateScope || this, this.vars.onUpdateParams || c))),
                                a &&
                                    (this._gc ||
                                        ((d === this._startTime || m !== this._timeScale) &&
                                            (0 === this._time || f >= this.totalDuration()) &&
                                            (s && (h.length && u(), this._timeline.autoRemoveChildren && this._enabled(!1, !1), (this._active = !1)),
                ...
                return (
                    ...
                    (u.render = function (t, e, i) {
                        ...
                        if (
                            (t >= p
                                ? (this._locked || ((this._totalTime = p), (this._cycle = this._repeat)),
                                  this._reversed || this._hasPausedChild() || ((o = !0), (u = "onComplete"), 0 === this._duration && (0 === t || 0 > y || y === r) && y !== t && this._first && ((c = !0), y > r && (u = "onReverseComplete"))),
                                  (this._rawPrevTime = this._duration || !e || t || this._rawPrevTime === t ? t : r),
                                  this._yoyo && 0 !== (1 & this._cycle) ? (this._time = t = 0) : ((this._time = d), (t = d + 1e-4)))
                                : 1e-7 > t
                                ? (this._locked || (this._totalTime = this._cycle = 0),
                                  (this._time = 0),
                                  (0 !== m || (0 === d && y !== r && (y > 0 || (0 > t && y >= 0)) && !this._locked)) && ((u = "onReverseComplete"), (o = this._reversed)),
                                  0 > t ? ((this._active = !1), y >= 0 && this._first && (c = !0), (this._rawPrevTime = t)) : ((this._rawPrevTime = d || !e || t || this._rawPrevTime === t ? t : r), (t = 0), this._initted || (c = !0)))
                                : (0 === d && 0 > y && (c = !0),
                                  ...
                                  this._locked ||
                                      ...
                                      0 !== this._repeat &&
                                          ...
                                          this._time > d ? ((this._time = d), (t = d + 1e-4)) : 0 > this._time ? (this._time = t = 0) : (t = this._time)))),
                            ...
                            if (
                                ...
                                b && ((m = x ? d + 1e-4 : -1e-4), this.render(m, !0, !1)),
                                (this._locked = !1),
                                this._paused && !T)
                            )
                                return;
                        ...
                        if (
                            ...
                            for (n = this._first; n && ((h = n._next), !this._paused || T); )
                                (n._active || (n._startTime <= this._time && !n._paused && !n._gc)) &&
                                    (n._reversed ? n.render((n._dirty ? n.totalDuration() : n._totalDuration) - (t - n._startTime) * n._timeScale, e, i) : n.render((t - n._startTime) * n._timeScale, e, i)),
                                    (n = h);
                        else
                            for (n = this._last; n && ((h = n._prev), !this._paused || T); )
                                (n._active || (m >= n._startTime && !n._paused && !n._gc)) &&
                                    (n._reversed ? n.render((n._dirty ? n.totalDuration() : n._totalDuration) - (t - n._startTime) * n._timeScale, e, i) : n.render((t - n._startTime) * n._timeScale, e, i)),
                                    (n = h);
                        this._onUpdate && (e || (a.length && l(), this._onUpdate.apply(this.vars.onUpdateScope || this, this.vars.onUpdateParams || s))),
                            u &&
                                (this._locked ||
                                    this._gc ||
                                    ((g === this._startTime || v !== this._timeScale) &&
                                        (0 === this._time || p >= this.totalDuration()) &&
                                        (o && (a.length && l(), this._timeline.autoRemoveChildren && this._enabled(!1, !1), (this._active = !1)),
        ...
        (function () {
            var t = 180 / Math.PI,
                    ...
                    for (h = 0; x > h; h++)
                        (p = t[b]),
                            ...
                            a
                                ? ((y = e[h]),
                                  (T = i[h]),
                                  (w = (0.25 * (T + y) * r) / (o ? 0.5 : n[h] || 0.5)),
                                  (d = c - (c - u) * (o ? 0.5 * r : 0 !== y ? w / y : 0)),
                                  (m = c + (f - c) * (o ? 0.5 * r : 0 !== T ? w / T : 0)),
                                  (_ = c - (d + (((m - d) * ((3 * y) / (y + T) + 0.5)) / 4 || 0))))
                                : ((d = c - 0.5 * (c - u) * r), (m = c + 0.5 * (f - c) * r), (_ = c - (d + m) / 2)),
                            (d += _),
                            (m += _),
                            (p.c = g = d),
                            ...
                            (p.ca = g - u),
                            (p.ba = P - u),
                            s ? ((v = l(u, P, g, c)), t.splice(b, 1, v[0], v[1], v[2], v[3]), (b += 4)) : b++,
                            (P = m);
                    (p = t[b]), (p.b = P), (p.c = P + 0.4 * (p.d - P)), (p.da = p.d - p.a), (p.ca = p.c - p.a), (p.ba = P - p.a), s && ((v = l(p.a, P, p.c, p.d)), t.splice(b, 1, v[0], v[1], v[2], v[3]));
                },
                u = function (t, n, r, s) {
                    var a,
                        l,
                ...
                c = function (t, s, o, l, c, f) {
                    ...
                    if (t.length > 1) {
                        for (T = t[t.length - 1], y = !0, p = x.length; --p > -1; )
                            if (((d = x[p]), Math.abs(b[d] - T[d]) > 0.05)) {
                                y = !1;
                                break;
                            }
                    ...
                    if (!l) {
                        for (p = x.length; --p > -1; ) if (r[d]) for (m = w[x[p]], v = m.length - 1, _ = 0; v > _; _++) (g = m[_ + 1].da / i[_] + m[_].da / e[_]), (n[_] = (n[_] || 0) + g * g);
                ...
                f = function (t, e, i) {
                    ...
                    for (h = v.length; --h > -1; ) {
                        for (f = v[h], m[f] = l = [], p = 0, c = t.length, u = 0; c > u; u++)
                            (n = null == i ? t[u][f] : "string" == typeof (d = t[u][f]) && "=" === d.charAt(1) ? i[f] + Number(d.charAt(0) + d.substr(2)) : Number(d)), g && u > 1 && c - 1 > u && (l[p++] = (n + l[p - 2]) / 2), (l[p++] = n);
                ...
                p = function (t, e, i) {
                    for (var n, r, s, o, a, l, h, u, c, f, p, d = 1 / i, m = t.length; --m > -1; )
                        for (f = t[m], s = f.a, o = f.d - s, a = f.c - s, l = f.b - s, n = r = 0, u = 1; i >= u; u++)
                            (h = d * u), (c = 1 - h), (n = r - (r = (h * h * o + 3 * c * (h * a + c * l)) * h)), (p = m * i + u - 1), (e[p] = (e[p] || 0) + n * n);
                },
                d = function (t, e) {
                    e = e >> 0 || 6;
                    var i,
                    ...
                    init: function (t, e, i) {
                        ...
                        for (s = this._props.length; --s > -1; )
                            (n = this._props[s]),
                                ...
                                a || (h[n] !== l[0][n] && (a = h));
                        if (
                            ((this._beziers = "cubic" !== e.type && "quadratic" !== e.type && "soft" !== e.type ? c(l, isNaN(e.curviness) ? 1 : e.curviness, !1, "thruBasic" === e.type, e.correlate, a) : f(l, e.type, h)),
                            ...
                            parser: function (t, e, s, o, a, l) {
                                ...
                                return (
                                    ...
                                    !_.autoRotate ||
                                        ...
                                        ((h = _.autoRotate === !0 ? 0 : Number(_.autoRotate)), (_.autoRotate = null != c.end.left ? [["left", "top", "rotation", h, !1]] : null != c.end.x ? [["x", "y", "rotation", h, !1]] : !1)),
                                    _.autoRotate && (o._transform || o._enableTransforms(!1), (c.autoRotate = o._target._gsTransform)),
        ...
        _gsScope._gsDefine(
            ...
            function (t, e) {
                ...
                var u,
                    ...
                    X = (function () {
                        var t = B.indexOf("Android"),
                            e = F("a");
                        return (
                            (f = -1 !== B.indexOf("Safari") && -1 === B.indexOf("Chrome") && (-1 === t || Number(B.substr(t + 8, 1)) > 3)),
                            (d = f && 6 > Number(B.substr(B.indexOf("Version/") + 8, 1))),
                    ...
                    G = (o.getStyle = function (t, e, i, n, r) {
                        var s;
                        return X || "opacity" !== e
                            ? (!n && t.style[e] ? (s = t.style[e]) : (i = i || Q(t)) ? (s = i[e] || i.getPropertyValue(e) || i.getPropertyValue(e.replace(S, "-$1").toLowerCase())) : t.currentStyle && (s = t.currentStyle[e]),
                    ...
                    $ = (W.convertToPixels = function (t, i, n, r, s) {
                        ...
                        if ((p && (n = -n), "%" === r && -1 !== i.indexOf("border"))) a = (n / 100) * (u ? t.clientWidth : t.clientHeight);
                            ...
                            c.appendChild(N),
                                ...
                                c.removeChild(N),
                                u && "%" === r && o.cacheWidths !== !1 && ((l = c._gsCache = c._gsCache || {}), (l.time = h), (l.width = 100 * (a / n))),
                                0 !== a || s || (a = $(t, i, n, r, !0));
                        }
                        return p ? -a : a;
                    }),
                    ...
                    J = function (t, e) {
                        var i,
                            n,
                            r = {};
                        if ((e = e || Q(t, null))) for (i in e) (-1 === i.indexOf("Transform") || xt === i) && (r[i] = e[i]);
                        else if ((e = t.currentStyle || t.style)) for (i in e) "string" == typeof i && void 0 === r[i] && (r[i.replace(C, E)] = e[i]);
                        return (
                            X || (r.opacity = Y(t)),
                            (n = At(t, e, !1)),
                    ...
                    K = function (t, e, i, n, r) {
                        ...
                        for (o in i)
                            "cssText" !== o &&
                                ...
                                ((l[o] = "auto" !== s || ("left" !== o && "top" !== o) ? (("" !== s && "auto" !== s && "none" !== s) || "string" != typeof e[o] || "" === e[o].replace(y, "") ? s : 0) : Z(t, o)),
                    ...
                    nt = function (t, e) {
                        ...
                        return (
                            ...
                            e && ((e.oxp = -1 !== n.indexOf("%")), (e.oyp = -1 !== r.indexOf("%")), (e.oxr = "=" === n.charAt(1)), (e.oyr = "=" === r.charAt(1)), (e.ox = parseFloat(n.replace(y, ""))), (e.oy = parseFloat(r.replace(y, "")))),
                            n + " " + r + (i.length > 2 ? " " + i[2] : "")
                        );
                    },
                    rt = function (t, e) {
                                ...
                                : ("," === t.charAt(t.length - 1) && (t = t.substr(0, t.length - 1)),
                                  at[t]
                                      ...
                                      ? ((t = t.match(_)),
                                        ...
                                        (t[2] = lt(r - 1 / 3, e, i)),
                                        t)
                                      : ((t = t.match(_) || at.transparent), (t[0] = Number(t[0])), (t[1] = Number(t[1])), (t[2] = Number(t[2])), t.length > 3 && (t[3] = Number(t[3])), t))
                            : at.black;
                    }),
                ...
                var ct = function (t, e, i, n) {
                        ...
                        return u
                            ? (r = e
                                  ? function (t) {
                                        ...
                                        if (((e = (t.match(ut) || [s])[0]), (f = t.split(e).join("").match(v) || []), (p = f.length), u > p--)) for (; u > ++p; ) f[p] = i ? f[0 | ((p - 1) / 2)] : o[p];
                                  ...
                                  : function (t) {
                                        ...
                                        if (((e = t.match(v) || []), (f = e.length), u > f--)) for (; u > ++f; ) e[f] = i ? e[0 | ((f - 1) / 2)] : o[f];
                                        return a + e.join(h) + l;
                                    })
                            : function (t) {
                                  return t;
                    ...
                    mt = (o.parseComplex = function (t, e, i, n, r, s, o, a, l, h) {
                        ...
                        var c,
                            ...
                            R = u !== !1;
                        for (
                            (-1 !== n.indexOf(",") || -1 !== i.indexOf(",")) && ((C = C.join(" ").replace(A, ", ").split(" ")), (O = O.join(" ").replace(A, ", ").split(" ")), (E = C.length)),
                                E !== O.length && ((C = (s || "").split(" ")), (E = C.length)),
                                o.plugin = l,
                                o.setRatio = h,
                                c = 0;
                            E > c;
                            ...
                            if (((d = C[c]), (m = O[c]), (T = parseFloat(d)), T || 0 === T)) o.appendXtra("", T, rt(m, T), m.replace(g, ""), R && -1 !== m.indexOf("px"), !0);
                                ...
                                (S = "," === m.charAt(m.length - 1) ? ")," : ")"),
                                    ...
                                    w && !X && 0 === m[3]
                                        ...
                                        : (X || (w = !1),
                                          o
                                              .appendXtra(w ? "rgba(" : "rgb(", d[0], m[0] - d[0], ",", !0, !0)
                                              .appendXtra("", d[1], m[1] - d[1], ",", !0)
                                              .appendXtra("", d[2], m[2] - d[2], w ? "," : S, !0),
                                          w && ((d = 4 > d.length ? 1 : d[3]), o.appendXtra("", d, (4 > m.length ? 1 : m[3]) - d, S, !1)));
                            else if ((v = d.match(_))) {
                        ...
                        return (
                            ...
                            i || 0 === a || o.plugin
                                ? (o.l++,
                                  ...
                                  (o["xs" + o.l] = n || ""),
                                  a > 0
                                      ? ((o.data["xn" + a] = e + i), (o.rxp["xn" + a] = r), (o["xn" + a] = e), o.plugin || ((o.xfirst = new dt(o, "xn" + a, e, i, o.xfirst || o, 0, o.n, r, o.pr)), (o.xfirst.xs0 = 0)), o)
                    ...
                    (h.parseComplex = function (t, e, i, n, r, s) {
                        ...
                        if ((this.multi && (A.test(i) || A.test(e) ? ((a = e.replace(A, "|").split("|")), (l = i.replace(A, "|").split("|"))) : f && ((a = [e]), (l = [i]))), l)) {
                            for (h = l.length > a.length ? l.length : a.length, o = 0; h > o; o++)
                                (e = a[o] = a[o] || this.dflt), (i = l[o] = l[o] || this.dflt), f && ((u = e.indexOf(f)), (c = i.indexOf(f)), u !== c && ((i = -1 === c ? l : a), (i[o] += " " + f)));
                            (e = a.join(", ")), (i = l.join(", "));
                        }
                ...
                var Tt,
                    ...
                    At = (W.getTransform = function (t, e, i, n) {
                        ...
                        var s,
                            ...
                            d,
                            m,
                            _ = i ? t._gsTransform || new Ct() : new Ct(),
                            g = 0 > _.scaleX,
                            v = 2e-5,
                            y = 1e5,
                        ...
                        if (
                            (xt
                                ? (a = G(t, bt, e, !0))
                                : t.currentStyle && ((a = t.currentStyle.filter.match(k)), (a = a && 4 === a.length ? [a[0].substr(4), Number(a[2].substr(4)), Number(a[1].substr(4)), a[3].substr(4), _.x || 0, _.y || 0].join(",") : "")),
                            ...
                            _.svg && (zt(t, G(t, Pt, r, !1, "50% 50%") + "", _), (Tt = o.useSVGTransformAttr || kt), (l = t.getAttribute("transform")), s && l && -1 !== l.indexOf("matrix") && ((a = l), (s = 0))),
                            !s)
                        ) {
                            for (l = (a || "").match(/(?:\-|\b)[\d\-\.e]+\b/gi) || [], h = l.length; --h > -1; ) (u = Number(l[h])), (l[h] = (c = u - (u |= 0)) ? (0 | (c * y + (0 > c ? -0.5 : 0.5))) / y + u : u);
                            if (16 === l.length) {
                                var x,
                                    b,
                                    P,
                                    ...
                                    Y = l[11],
                                    q = Math.atan2(I, j);
                                _.zOrigin && ((X = -_.zOrigin), (W = F * X - l[12]), (B = N * X - l[13]), (X = j * X + _.zOrigin - l[14])),
                                    (_.rotationX = q * L),
                                    q &&
                                        ((S = Math.cos(-q)),
                                        (C = Math.sin(-q)),
                                    ...
                                    (q = Math.atan2(F, j)),
                                    (_.rotationY = q * L),
                                    q && ((S = Math.cos(-q)), (C = Math.sin(-q)), (x = O * S - F * C), (b = E * S - N * C), (P = R * S - j * C), (N = E * C + N * S), (j = R * C + j * S), (Y = z * C + Y * S), (O = x), (E = b), (R = P)),
                                    (q = Math.atan2(E, O)),
                                    (_.rotation = q * L),
                                    q && ((S = Math.cos(-q)), (C = Math.sin(-q)), (O = O * S + A * C), (b = E * S + M * C), (M = E * -C + M * S), (I = R * -C + I * S), (E = b)),
                                    _.rotationX && Math.abs(_.rotationX) + Math.abs(_.rotation) > 359.9 && ((_.rotationX = _.rotation = 0), (_.rotationY += 180)),
                                    (_.scaleX = (0 | (Math.sqrt(O * O + E * E) * y + 0.5)) / y),
                                    (_.scaleY = (0 | (Math.sqrt(M * M + N * N) * y + 0.5)) / y),
                                    (_.scaleZ = (0 | (Math.sqrt(I * I + j * j) * y + 0.5)) / y),
                                    (_.skewX = 0),
                                ...
                                (_.x = l[4] || 0),
                                    ...
                                    (f = Math.sqrt(U * U + V * V)),
                                    (p = Math.sqrt($ * $ + Q * Q)),
                                    (d = U || V ? Math.atan2(V, U) * L : _.rotation || 0),
                                    (m = Q || $ ? Math.atan2(Q, $) * L + d : _.skewX || 0),
                                    Math.abs(m) > 90 && 270 > Math.abs(m) && (g ? ((f *= -1), (m += 0 >= d ? 180 : -180), (d += 0 >= d ? 180 : -180)) : ((p *= -1), (m += 0 >= m ? 180 : -180))),
                                    (_.scaleX = f),
                                    (_.scaleY = p),
                                    (_.rotation = d),
                                    (_.skewX = m),
                                    St && ((_.rotationX = _.rotationY = _.z = 0), (_.perspective = w), (_.scaleZ = 1));
                            }
                            _.zOrigin = T;
                    ...
                    Mt = function (t) {
                        ...
                        if (f) {
                            ...
                            if (
                                (null != n.ox && ((p = (n.oxp ? 0.01 * _ * n.ox : n.ox) - _ / 2), (d = (n.oyp ? 0.01 * g * n.oy : n.oy) - g / 2), (x += p - (p * a + d * l)), (b += d - (p * h + d * u))),
                                v ? ((p = _ / 2), (d = g / 2), (y += ", Dx=" + (p - (p * a + d * l) + x) + ", Dy=" + (d - (p * h + d * u) + b) + ")")) : (y += ", sizingMethod='auto expand')"),
                                ...
                                (0 === t || 1 === t) &&
                                    ...
                                    0 === h &&
                                    1 === u &&
                                    ((v && -1 === y.indexOf("Dx=0, Dy=0")) || (w.test(e) && 100 !== parseFloat(RegExp.$1)) || (-1 === e.indexOf(e.indexOf("Alpha")) && c.removeAttribute("filter"))),
                                !v)
                            ) {
                                var P,
                                    S,
                                ...
                                for (
                                    ...
                                    (S = et[_t]),
                                        ...
                                        (C = i !== n[S] ? (2 > _t ? -n.ieOffsetX : -n.ieOffsetY) : 2 > _t ? p - n.ieOffsetX : d - n.ieOffsetY),
                    ...
                    Lt = (W.set3DTransformRatio = function (t) {
                        ...
                        if ((p && ((m = 1e-4), m > C && C > -m && (C = E = 2e-5), m > O && O > -m && (O = E = 2e-5), !A || b.z || b.rotationX || b.rotationY || (A = 0)), S || b.skewX))
                            (_ = e = Math.cos(S)),
                                (g = r = Math.sin(S)),
                                b.skewX && ((S -= b.skewX * M), (_ = Math.cos(S)), (g = Math.sin(S)), "simple" === b.skewType && ((v = Math.tan(b.skewX * M)), (v = Math.sqrt(1 + v * v)), (_ *= v), (g *= v))),
                                (i = -g),
                                (s = _);
                        else {
                        ...
                        (h = 1),
                            ...
                            (x = "0"),
                            (S = b.rotationY * M),
                            S && ((_ = Math.cos(S)), (g = Math.sin(S)), (a = -g), (u = f * -g), (n = e * g), (o = r * g), (h = _), (f *= _), (e *= _), (r *= _)),
                            (S = b.rotationX * M),
                            S && ((_ = Math.cos(S)), (g = Math.sin(S)), (v = i * _ + n * g), (y = s * _ + o * g), (l = h * g), (c = f * g), (n = i * -g + n * _), (o = s * -g + o * _), (h *= _), (f *= _), (i = v), (s = y)),
                            1 !== E && ((n *= E), (o *= E), (h *= E), (f *= E)),
                            1 !== O && ((i *= O), (s *= O), (l *= O), (c *= O)),
                            1 !== C && ((e *= C), (r *= C), (a *= C), (u *= C)),
                            (d || b.svg) &&
                                (d && ((R += n * -d), (k += o * -d), (z += h * -d + d)),
                                b.svg && ((R += b.xOrigin - (b.xOrigin * e + b.yOrigin * i)), (k += b.yOrigin - (b.xOrigin * r + b.yOrigin * s))),
                                m > R && R > -m && (R = x),
                                m > k && k > -m && (k = x),
                                m > z && z > -m && (z = 0)),
                            ...
                            b.rotationX || b.rotationY
                                ? ((T += w + (m > l && l > -m ? x : l) + w + (m > c && c > -m ? x : c) + w + (m > n && n > -m ? x : n)),
                                  (T += w + (m > o && o > -m ? x : o) + w + (m > h && h > -m ? x : h) + w + (m > f && f > -m ? x : f) + w))
                                : (T += ",0,0,0,0,1,0,"),
                    ...
                    It = (W.set2DTransformRatio = function (t) {
                        var e,
                            ...
                            m = f.x,
                            _ = f.y;
                        return !(f.rotationX || f.rotationY || f.z || f.force3D === !0 || ("auto" === f.force3D && 1 !== t && 0 !== t)) || (f.svg && Tt) || !St
                            ? ((r = f.scaleX),
                              (s = f.scaleY),
                              void (f.rotation || f.skewX || f.svg
                                  ? ((e = f.rotation * M),
                                    (i = e - f.skewX * M),
                                    (n = 1e5),
                                    (o = Math.cos(e) * r),
                                    ...
                                    (l = Math.sin(i) * -s),
                                    (h = Math.cos(i) * s),
                                    f.svg && ((m += f.xOrigin - (f.xOrigin * o + f.yOrigin * l)), (_ += f.yOrigin - (f.xOrigin * a + f.yOrigin * h)), (c = 1e-6), c > m && m > -c && (m = 0), c > _ && _ > -c && (_ = 0)),
                                    (u = (0 | (o * n)) / n + "," + (0 | (a * n)) / n + "," + (0 | (l * n)) / n + "," + (0 | (h * n)) / n + "," + m + "," + _ + ")"),
                                    f.svg && Tt ? p.setAttribute("transform", "matrix(" + u) : (d[xt] = (f.xPercent || f.yPercent ? "translate(" + f.xPercent + "%," + f.yPercent + "%) matrix(" : "matrix(") + u))
                                  : (d[xt] = (f.xPercent || f.yPercent ? "translate(" + f.xPercent + "%," + f.yPercent + "%) matrix(" : "matrix(") + r + ",0,0," + s + "," + m + "," + _ + ")")))
                ...
                (h = Ct.prototype),
                        ...
                        "transform,scale,scaleX,scaleY,scaleZ,x,y,z,rotation,rotationX,rotationY,rotationZ,skewX,skewY,shortRotation,shortRotationX,shortRotationY,shortRotationZ,transformOrigin,transformPerspective,directionalRotation,parseTransform,force3D,skewType,xPercent,yPercent",
                        {
                            parser: function (t, e, i, n, s, a, l) {
                                ...
                                var h,
                                    ...
                                    d,
                                    m,
                                    _ = (n._transform = At(t, r, !0, l.parseTransform)),
                                    g = t.style,
                                    v = 1e-6,
                                    y = wt.length,
                                    T = l,
                                ...
                                if ("string" == typeof T.transform && xt) (c = N.style), (c[xt] = T.transform), (c.display = "block"), (c.position = "absolute"), D.body.appendChild(N), (h = At(N, null, !1)), D.body.removeChild(N);
                                    ...
                                    if (
                                        ...
                                        if ("object" == typeof m) for (c in m) T[c] = m[c];
                                        else T.rotation = m;
                                    "string" == typeof T.x && -1 !== T.x.indexOf("%") && ((h.x = 0), (h.xPercent = st(T.x, _.xPercent))),
                                        "string" == typeof T.y && -1 !== T.y.indexOf("%") && ((h.y = 0), (h.yPercent = st(T.y, _.yPercent))),
                                        ...
                                        St &&
                                            ((h.rotationX = ot("rotationX" in T ? T.rotationX : "shortRotationX" in T ? T.shortRotationX + "_short" : _.rotationX || 0, _.rotationX, "rotationX", w)),
                                        ...
                                        (u = h.skewY - _.skewY) && ((h.skewX += u), (h.rotation += u));
                                }
                                for (
                                    St && null != T.force3D && ((_.force3D = T.force3D), (d = !0)),
                                        _.skewType = T.skewType || _.skewType || o.defaultSkewType,
                                        p = _.force3D || _.z || _.rotationX || _.rotationY || h.z || h.rotationX || h.rotationY || h.perspective,
                                    ...
                                    (i = wt[y]),
                                        (f = h[i] - _[i]),
                                        (f > v || -v > f || null != T[i] || null != I[i]) && ((d = !0), (s = new dt(_, i, _[i], f, s)), i in w && (s.e = w[i]), (s.xs0 = 0), (s.plugin = a), n._overwriteProps.push(s.n));
                                return (
                                    (f = T.transformOrigin),
                                    f &&
                                        _.svg &&
                                        ...
                                        (xt
                                            ? ((d = !0),
                                              ...
                                              St
                                                  ? ((c = _.zOrigin),
                                                    (f = f.split(" ")),
                                                    (_.zOrigin = (f.length > 2 && (0 === c || "0px" !== f[2]) ? parseFloat(f[2]) : c) || 0),
                                                  ...
                                                  : (s.xs0 = s.e = f))
                                            : nt(f + "", _)),
                                    d && (n._transformType = (_.svg && Tt) || (!p && 3 !== this._transformType) ? 2 : 3),
                                    s
                                );
                            },
                            prefix: !0,
                    ...
                    vt("boxShadow", { defaultValue: "0px 0px 0px 0px #999", prefix: !0, color: !0, multi: !0, keyword: "inset" }),
                    vt("borderRadius", {
                        defaultValue: "0px",
                        parser: function (t, e, i, s, o) {
                            ...
                            var a,
                                ...
                                P = t.style;
                            for (m = parseFloat(t.offsetWidth), _ = parseFloat(t.offsetHeight), a = e.split(" "), l = 0; b.length > l; l++)
                                this.p.indexOf("border") && (b[l] = V(b[l])),
                                    ...
                                    (v = c.substr((p + "").length)),
                                    (y = "=" === f.charAt(1)),
                                    y ? ((d = parseInt(f.charAt(0) + "1", 10)), (f = f.substr(2)), (d *= parseFloat(f)), (g = f.substr((d + "").length - (0 > d ? 1 : 0)) || "")) : ((d = parseFloat(f)), (g = f.substr((d + "").length))),
                                    "" === g && (g = n[i] || v),
                                    g !== v &&
                                        ((T = $(t, "borderLeft", p, v)),
                                        (w = $(t, "borderTop", p, v)),
                                        "%" === g ? ((c = 100 * (T / m) + "%"), (u = 100 * (w / _) + "%")) : "em" === g ? ((x = $(t, "borderLeft", 1, "em")), (c = T / x + "em"), (u = w / x + "em")) : ((c = T + "px"), (u = w + "px")),
                                        y && ((f = parseFloat(c) + d + g), (h = parseFloat(u) + d + g))),
                                    (o = mt(P, b[l], c + " " + u, f + " " + h, !1, "0px", o));
                            return o;
                        },
                        prefix: !0,
                    ...
                    vt("backgroundPosition", {
                        ...
                        parser: function (t, e, i, n, s, o) {
                            ...
                            if ((-1 !== _.indexOf("%")) != (-1 !== g.indexOf("%")) && ((f = G(t, "backgroundImage").replace(O, "")), f && "none" !== f)) {
                                for (a = _.split(" "), l = g.split(" "), j.setAttribute("src", f), h = 2; --h > -1; )
                                    (_ = a[h]),
                                        (u = -1 !== _.indexOf("%")),
                                        u !== (-1 !== l[h].indexOf("%")) && ((c = 0 === h ? t.offsetWidth - j.width : t.offsetHeight - j.height), (a[h] = u ? (parseFloat(_) / 100) * c + "px" : 100 * (parseFloat(_) / c) + "%"));
                                _ = a.join(" ");
                            }
                    ...
                    vt("margin", { parser: ft("marginTop,marginRight,marginBottom,marginLeft") }),
                    vt("padding", { parser: ft("paddingTop,paddingRight,paddingBottom,paddingLeft") }),
                    vt("clip", {
                    ...
                    vt("textShadow", { defaultValue: "0px 0px 0px #999", color: !0, multi: !0 }),
                    ...
                    vt("borderWidth", { parser: ft("borderTopWidth,borderRightWidth,borderBottomWidth,borderLeftWidth") }),
                ...
                var Dt = function (t) {
                    var e,
                        ...
                        r = 0 | (this.s + this.c * t);
                    100 === r && (-1 === n.indexOf("atrix(") && -1 === n.indexOf("radient(") && -1 === n.indexOf("oader(") ? (i.removeAttribute("filter"), (e = !G(this.data, "filter"))) : ((i.filter = n.replace(b, "")), (e = !0))),
                        ...
                        return (
                            ...
                            X
                                ...
                                : ((s = new dt(l, "opacity", 100 * a, 100 * (e - a), s)),
                                  ...
                                  (s.plugin = o),
                                  (s.setRatio = Dt)),
                            h && ((s = new dt(l, "visibility", 0, 0, s, -1, null, !1, 0, 0 !== a ? "inherit" : "hidden", 0 === e ? "hidden" : "inherit")), (s.xs0 = "inherit"), n._overwriteProps.push(s.n), n._overwriteProps.push(i)),
                            s
                        );
                    },
                });
                ...
                vt("className", {
                    parser: function (t, e, n, s, o, a, l) {
                        ...
                        return (
                            ...
                            s._tween._duration && (t.setAttribute("class", o.e), (h = K(t, u, J(t), l, f)), t.setAttribute("class", d), (o.data = h.firstMPT), (t.style.cssText = m), (o = o.xfirst = s.parse(t, h.difs, o, a))),
                            o
                        );
                    },
                });
                var jt = function (t) {
                    if ((1 === t || 0 === t) && this.data._totalTime === this.data._totalDuration && "isFromStart" !== this.data.data) {
                        ...
                        else for (e = this.e.split(" ").join("").split(","), n = e.length; --n > -1; ) (i = e[n]), l[i] && (l[i].parse === o ? (r = !0) : (i = "transformOrigin" === i ? Pt : l[i].p)), Ft(s, i);
                ...
                (h = o.prototype),
                    ...
                    (h._onInitTween = function (t, e, a) {
                        ...
                        var l,
                            ...
                            w = t.style;
                        if (
                            (c && "" === w.zIndex && ((l = G(t, "zIndex", r)), ("auto" === l || "" === l) && this._addLazySet(w, "zIndex", 0)),
                            "string" == typeof e && ((m = w.cssText), (l = J(t, r)), (w.cssText = m + ";" + e), (l = K(t, l, J(t)).difs), !X && x.test(e) && (l.opacity = parseFloat(RegExp.$1)), (e = l), (w.cssText = m)),
                            ...
                            for (
                                T = 3 === this._transformType,
                                    xt
                                        ? f &&
                                          ((c = !0),
                                          "" === w.zIndex && ((v = G(t, "zIndex", r)), ("auto" === v || "" === v) && this._addLazySet(w, "zIndex", 0)),
                                          d && this._addLazySet(w, "WebkitBackfaceVisibility", this._vars.WebkitBackfaceVisibility || (T ? "visible" : "hidden")))
                                        : (w.zoom = 1),
                                    p = h;
                                p && p._next;
                        ...
                        for (o in e)
                            (p = e[o]),
                                ...
                                a
                                    ...
                                    : ((f = G(t, o, r) + ""),
                                      (_ = "string" == typeof p),
                                      "color" === o || "fill" === o || "stroke" === o || -1 !== o.indexOf("Color") || (_ && P.test(p))
                                          ? (_ || ((p = ht(p)), (p = (p.length > 3 ? "rgba(" : "rgb(") + p.join(",") + ")")), (i = mt(v, o, f, p, !0, "transparent", i, 0, s)))
                                          : !_ || (-1 === p.indexOf(" ") && -1 === p.indexOf(","))
                                          ? ((h = parseFloat(f)),
                                            (d = h || 0 === h ? f.substr((h + "").length) : ""),
                                            ("" === f || "auto" === f) &&
                                                ("width" === o || "height" === o ? ((h = it(t, o, r)), (d = "px")) : "left" === o || "top" === o ? ((h = Z(t, o, r)), (d = "px")) : ((h = "opacity" !== o ? 0 : 1), (d = ""))),
                                            (g = _ && "=" === p.charAt(1)),
                                            g ? ((c = parseInt(p.charAt(0) + "1", 10)), (p = p.substr(2)), (c *= parseFloat(p)), (m = p.replace(T, ""))) : ((c = parseFloat(p)), (m = _ ? p.replace(T, "") : "")),
                                            "" === m && (m = o in n ? n[o] : d),
                                            (p = c || 0 === c ? (g ? c + h : c) + m : e[o]),
                                            d !== m &&
                                                "" !== m &&
                                                (c || 0 === c) &&
                                                h &&
                                                ((h = $(t, o, h, d)),
                                                "%" === m ? ((h /= $(t, o, 100, "%") / 100), e.strictUnits !== !0 && (f = h + "%")) : "em" === m ? (h /= $(t, o, 1, "em")) : "px" !== m && ((c = $(t, o, c, m)), (m = "px")),
                                                g && (c || 0 === c) && (p = c + h + m)),
                                            g && (c += h),
                                            (!h && 0 !== h) || (!c && 0 !== c)
                                                ? void 0 !== v[o] && (p || ("NaN" != p + "" && null != p))
                                                    ? ((i = new dt(v, o, c || h || 0, 0, i, -1, o, !1, 0, f, p)), (i.xs0 = "none" !== p || ("display" !== o && -1 === o.indexOf("Style")) ? p : f))
                                                    : q("invalid " + o + " tween value: " + e[o])
                                                : ((i = new dt(v, o, h, c - h, i, 0, o, u !== !1 && ("px" === m || "zIndex" === o), 0, f, p)), (i.xs0 = m)))
                ...
                var Bt = function (t, e, i) {
                    ...
                    else for (n = t.childNodes, r = n.length; --r > -1; ) (s = n[r]), (o = s.type), s.style && (e.push(J(s)), i && i.push(s)), (1 !== o && 9 !== o && 11 !== o) || !s.childNodes.length || Bt(s, e, i);
                };
                return (
            ...
            init: function (t, e) {
                ...
                for (i in e)
                    "useRadians" !== i &&
                        ...
                        a.length &&
                            ((n = a.join("_")),
                            -1 !== n.indexOf("short") && ((o %= l), o !== o % (l / 2) && (o = 0 > o ? o + l : o - l)),
                ...
                return (
                        ...
                        function (e) {
                            ...
                            for (
                                ...
                                (i = d ? Math.random() : (1 / c) * p),
                                    (n = _ ? _.getRatio(i) : i),
                                    "none" === l ? (r = g) : "out" === l ? ((s = 1 - i), (r = s * s * g)) : "in" === l ? (r = i * i * g) : 0.5 > i ? ((s = 2 * i), (r = 0.5 * s * s * g)) : ((s = 2 * (1 - i)), (r = 0.5 * s * s * g)),
                    ...
                    c(
                        ...
                        n(
                            "ElasticInOut",
                            function (t) {
                                return 1 > (t *= 2) ? -0.5 * this._p1 * Math.pow(2, 10 * (t -= 1)) * Math.sin(((t - this._p3) * o) / this._p2) : 0.5 * this._p1 * Math.pow(2, -10 * (t -= 1)) * Math.sin(((t - this._p3) * o) / this._p2) + 1;
                            },
                            0.45
                        )
                    ),
    ...
    (function (t, e) {
        ...
        if (!i.TweenLite) {
            ...
            for (
                ...
                (s = n[r] + ",Power" + r), x(new T(null, null, 1, r), s, "easeOut", !0), x(new T(null, null, 2, r), s, "easeIn" + (0 === r ? ",easeNone" : "")), x(new T(null, null, 3, r), s, "easeInOut");
            ...
            (s = b.prototype),
                (s.addEventListener = function (t, e, i, n, r) {
                    ...
                    h.splice(u, 0, { c: e, s: i, up: n, pr: r }), this !== o || a || o.wake();
                }),
                ...
                var i,
                    ...
                    g = function (t) {
                        var e,
                            o,
                            a = C() - O;
                        a > d && (c += a - m), (O += a), (h.time = (O - c) / 1e3), (e = h.time - l), (!i || e > 0 || t === !0) && (h.frame++, (l += e + (e >= s ? 0.004 : s - e)), (o = !0)), t !== !0 && (r = n(g)), o && h.dispatchEvent(_);
                    };
                b.call(h),
                    (h.time = h.frame = 0),
                    (h.tick = function () {
            ...
            var z = g(
                                    ...
                                    s
                                        ? "string" != typeof s
                                            ? s.length && s !== t && s[0] && (s[0] === t || (s[0].nodeType && s[0].style && !s.nodeType))
                                                ? (o.splice(r--, 1), (this._targets = o = o.concat(c(s))))
                                                : ((this._siblings[r] = H(s, this, !1)), 1 === l && this._siblings[r].length > 1 && V(s, this, null, 1, this._siblings[r]))
                                            : ((s = o[r--] = z.selector(s)), "string" == typeof s && o.splice(r + 1, 1))
                                        : o.splice(r--, 1);
                ...
                M = function (t, e) {
                    var i,
                        n = {};
                    for (i in t)
                        W[i] || (i in e && "transform" !== i && "x" !== i && "y" !== i && "width" !== i && "height" !== i && "className" !== i && "border" !== i) || !(!F[i] || (F[i] && F[i]._autoCSS)) || ((n[i] = t[i]), delete t[i]);
                    t.css = n;
                };
            (s = z.prototype = new E()),
                (s.constructor = z),
            ...
            var L = [],
                I = {},
                D = (z._internals = { isArray: p, isSelector: A, lazyTweens: L }),
                F = (z._plugins = {}),
                N = (D.tweenLookup = {}),
                j = 0,
                W = (D.reservedProps = {
            ...
            var H = function (t, e, i) {
                    var n,
                        r,
                        s = t._gsTweenID;
                    if ((N[s || (t._gsTweenID = s = "t" + j++)] || (N[s] = { target: t, tweens: [] }), e && ((n = N[s].tweens), (n[(r = n.length)] = e), i))) for (; --r > -1; ) n[r] === e && n.splice(r, 1);
                    return N[s].tweens;
                },
                U = function (t, e, i, n) {
                    var r,
                    ...
                    for (s = r.length; --s > -1; )
                        (a = r[s]) === e ||
                            ...
                            (a._timeline !== e._timeline
                                ? ((h = h || Q(e, 0, d)), 0 === Q(a, h, d) && (f[p++] = a))
                                : c >= a._startTime && a._startTime + a.totalDuration() / a._timeScale > c && (((d || !a._initted) && 2e-10 >= c - a._startTime) || (f[p++] = a)));
                    for (s = p; --s > -1; )
            ...
            (s._init = function () {
                ...
                if (
                    ((this._ease = h = h ? (h instanceof T ? h : "function" == typeof h ? new T(h, s.easeParams) : w[h] || z.defaultEase) : z.defaultEase),
                ...
                (s._initProps = function (e, i, n, r) {
                    ...
                    for (s in this.vars) {
                        if (((u = this.vars[s]), W[s])) u && (u instanceof Array || (u.push && p(u))) && -1 !== u.join("").indexOf("{self}") && (this.vars[s] = u = this._swapSelfInParams(u, this));
                            ...
                            for (this._firstPT = h = { _next: this._firstPT, t: l, p: "setRatio", s: 0, c: 1, f: !0, n: s, pg: !0, pr: l._priority }, o = l._overwriteProps.length; --o > -1; ) i[l._overwriteProps[o]] = this._firstPT;
                            (l._priority || l._onInitAllProps) && (a = !0), (l._onDisable || l._onEnable) && (this._notifyPluginsOfEnabled = !0);
                        } else
                            (this._firstPT = i[s] = h = { _next: this._firstPT, t: e, p: s, f: "function" == typeof e[s], n: s, pg: !1, pr: 0 }),
                ...
                (s.render = function (t, e, i) {
                    ...
                    if (t >= l)
                        (this._totalTime = this._time = l),
                            ...
                            0 === l &&
                                ...
                                (0 === t || 0 > h || (h === u && "isPause" !== this.data)) && h !== t && ((i = !0), h > u && (r = "onReverseComplete")),
                                (this._rawPrevTime = o = !e || t || h === t ? t : u));
                    else if (1e-7 > t)
                        (this._totalTime = this._time = 0),
                            (this.ratio = this._ease._calcEnd ? this._ease.getRatio(0) : 0),
                            (0 !== a || (0 === l && h > 0 && h !== u)) && ((r = "onReverseComplete"), (n = this._reversed)),
                    ...
                    if (this._time !== a || i) {
                        ...
                        this._onUpdate && (0 > t && this._startAt && t !== -1e-4 && this._startAt.render(t, e, i), e || ((this._time !== a || n) && this._onUpdate.apply(this.vars.onUpdateScope || this, this.vars.onUpdateParams || y))),
                            r &&
                                (!this._gc || i) &&
                ...
                (s._enabled = function (t, e) {
                    if ((a || o.wake(), t && this._gc)) {
                        var i,
                            n = this._targets;
                        if (n) for (i = n.length; --i > -1; ) this._siblings[i] = H(n[i], this, !0);
                ...
                (z.getTweensOf = function (t, e) {
                    ...
                    } else for (n = H(t).concat(), i = n.length; --i > -1; ) (n[i]._gc || (e && !n[i].isActive())) && n.splice(i, 1);
                    return n;
                }),
            ...
            if (
                ...
                (s._addTween = function (t, e, i, n, r, s) {
                    var o, a;
                    return null != n && (o = "number" == typeof n || "=" !== n.charAt(1) ? Number(n) - i : parseInt(n.charAt(0) + "1", 10) * Number(n.substr(2)))
                        ? ((this._firstPT = a = { _next: this._firstPT, t: t, p: e, s: i, c: o, f: "function" == typeof t[e], n: r || e, r: s }), a._next && (a._next._prev = a), a)
                        : void 0;
                }),
        ...
        t.Controller = function (n) {
            ...
            return (
                ...
                (this.updateScene = function (e, i) {
                    return (
                        r.type.Array(e)
                            ...
                            : i
                            ? e.update(!0)
                            : m !== !0 && e instanceof t.Scene && ((m = m || []), -1 == m.indexOf(e) && m.push(e), (m = k(m)), O()),
                        f
                    );
                }),
                (this.update = function (t) {
                    return E({ type: "resize" }), t && C(), f;
                }),
                ...
                (this.info = function (t) {
                    var e = { size: y, vertical: p.vertical, scrollPos: _, scrollDirection: g, container: p.container, isDocument: v };
            ...
            (t.Scene = function (i) {
                ...
                (this.on = function (t, e) {
                    ...
                    (this.addTo = function (e) {
                        return (
                            e instanceof t.Controller && o != e && (o && o.removeScene(c), (o = e), S(), w(!0), x(!0), T(), o.info("container").addEventListener("resize", b), e.addScene(c), c.trigger("add", { controller: o }), c.update()),
                            c
                        );
                    }),
                    (this.enabled = function (t) {
                    ...
                    (this.destroy = function (t) {
                        return c.trigger("destroy", { reset: t }), c.remove(), c.off("*.*"), null;
                    }),
                    (this.update = function (t) {
                        if (o)
                            if (t)
                                if (o.enabled() && g) {
                                    var e,
                                        i = o.info("scrollPos");
                                    (e = f.duration > 0 ? (i - m.start) / (m.end - m.start) : i >= m.start ? 1 : 0), c.trigger("update", { startPos: m.start, endPos: m.end, scrollPos: i }), c.progress(e);
                                } else E && p === l && k(!0);
                ...
                var T = function () {
                        (m = { start: _ + f.offset }), o && f.triggerElement && (m.start -= o.info("size") * f.triggerHook), (m.end = m.start + f.duration);
                    },
                    w = function (t) {
                        if (s) {
                            var e = "duration";
                            C(e, s.call(c)) && !t && (c.trigger("change", { what: e, newval: f[e] }), c.trigger("shift", { reason: e }));
                        }
                    },
                    x = function (t) {
                        var i = 0,
                        ...
                        var u = i != _;
                        (_ = i), u && !t && c.trigger("shift", { reason: "triggerElementPosition" });
                    },
                    b = function () {
                        f.triggerHook > 0 && c.trigger("shift", { reason: "containerResize" });
                    },
                    ...
                    O = function (t) {
                        c[t] ||
                            (c[t] = function (e) {
                                return arguments.length ? ("duration" === t && (s = void 0), C(t, e) && (c.trigger("change", { what: t, newval: f[t] }), n.shifts.indexOf(t) > -1 && c.trigger("shift", { reason: t })), c) : f[t];
                            });
                    };
                ...
                var k = function (t) {
                        if (E && o) {
                            ...
                            if (t || p !== l) {
                                var n = { position: R.inFlow ? "relative" : "absolute", top: 0, left: 0 },
                                    s = r.css(i, "position") != n.position;
                                R.pushFollowers
                                    ? f.duration > 0 && (p === h && 0 === parseFloat(r.css(R.spacer, "padding-top")) ? (s = !0) : p === a && 0 === parseFloat(r.css(R.spacer, "padding-bottom")) && (s = !0))
                                    : (n[e.vertical ? "top" : "left"] = f.duration * d),
                                    r.css(i, n),
                                    s && z();
                            } else {
                                "fixed" != r.css(i, "position") && (r.css(i, { position: "fixed" }), z());
                                var u = r.get.offset(R.spacer, !0),
                                    c = f.reverse || 0 === f.duration ? e.scrollPos - m.start : Math.round(d * f.duration * 10) / 10;
                                (u[e.vertical ? "top" : "left"] += c), r.css(R.spacer.firstChild, { top: u.top, left: u.left });
                            }
                        }
                    },
                    z = function () {
                        if (E && o && R.inFlow) {
                            ...
                            R.relSize.width || R.relSize.autoFullWidth
                                ? t
                                    ? r.css(E, { width: r.get.width(R.spacer) })
                                    : r.css(E, { width: "100%" })
                                : ((s["min-width"] = r.get.width(e ? E : i, !0, !0)), (s.width = t ? s["min-width"] : "auto")),
                                R.relSize.height
                                    ? t
                                        ? r.css(E, { height: r.get.height(R.spacer) - (R.pushFollowers ? f.duration : 0) })
                                        : r.css(E, { height: "100%" })
                                    : ((s["min-height"] = r.get.height(e ? i : E, !0, !n)), (s.height = t ? s["min-height"] : "auto")),
                                R.pushFollowers && ((s["padding" + (e ? "Top" : "Left")] = f.duration * d), (s["padding" + (e ? "Bottom" : "Right")] = f.duration * (1 - d))),
                                r.css(R.spacer, s);
                        }
                    },
                    A = function () {
                    ...
                    M = function () {
                        o &&
                            E &&
                            p === l &&
                            (((R.relSize.width || R.relSize.autoFullWidth) && r.get.width(window) != r.get.width(R.spacer.parentNode)) || (R.relSize.height && r.get.height(window) != r.get.height(R.spacer.parentNode))) &&
                            z();
                    },
                    L = function (t) {
                ...
                (this.setPin = function (t, i) {
                    ...
                    return (
                        R.relSize.width && r.css(u, { width: h.width }),
                        R.relSize.height && r.css(u, { height: h.height }),
                        u.appendChild(E),
                        r.css(E, { position: a ? "relative" : "absolute", margin: "auto", top: "auto", left: "auto", bottom: "auto", right: "auto" }),
                        (R.relSize.width || R.relSize.autoFullWidth) && r.css(E, { boxSizing: "border-box", mozBoxSizing: "border-box", webkitBoxSizing: "border-box" }),
        ...
        $(document).ready(function () {
            function t(t, e, i, n, r, s) {
                var o = [
                        ...
                        { featureType: "road", elementType: "geometry.fill", stylers: [{ color: e }, { saturation: "-30" }, { lightness: "30" }] },
                        { featureType: "road", elementType: "geometry.stroke", stylers: [{ color: e }, { saturation: "-30" }, { lightness: "30" }] },
                        { featureType: "landscape", stylers: [{ color: i }] },
                        { featureType: "transit", stylers: [{ color: i }] },
                        { elementType: "labels", stylers: [{ visibility: "off" }] },
                        { elementType: "labels.text", stylers: [{ visibility: "on" }] },
                        { elementType: "labels.icon", stylers: [{ visibility: "on" }] },
                    ],
                    a = new google.maps.Map(t, { center: { lat: n, lng: r }, scrollwheel: !1, styles: o, zoom: 11 }),
                    l = new google.maps.Marker({ map: a, position: { lat: n, lng: r }, animation: google.maps.Animation.DROP, title: "Our Location!" }),
                    h = new google.maps.InfoWindow({ content: s });
            ...
            var e = function (t, e) {
                ...
                r = function (t, e) {
                    if (t)
                        if ((t.progress(0), t.invalidate(), e)) for (var i = t.getChildren(), n = 0; n < i.length; n++) TweenMax.set(i[n].target, { clearProps: "all" });
                        else TweenMax.set(t.target, { clearProps: "all" });
                },
                s = function (t, e) {
                    for (var i = 0; i < e.length; i++) if (t.hasClass(e[i])) return !0;
                    return !1;
                };
            $(".read-more")
                .off("click.read-more")
            ...
            var o = function (t, e) {
                var i = t.closest(e),
                    n = i.outerHeight(),
                    r = i.offset().top + n;
                $("html, body").animate({ scrollTop: r }, 1e3);
            };
            $(".horizontal-half-wrapper .read-more")
                .off("click.read-more")
                .on("click.read-more", function (t) {
            ...
            var a = new ScrollMagic.Controller(),
                ...
                y = {
                    init: function (t) {
                        var o = { duration: void 0, responsiveThreshold: 768, scrollTriggered: !1, staggeredDelay: 0.8, reset: !0 };
                        t = $.extend(o, t);
                                ...
                                if (window.innerWidth >= c) {
                                    if (h.hasClass("gh")) {
                                        var k = h.find(".fade-transition"),
                                            z = TweenMax.to(k, 1, { scale: "0", opacity: 0, ease: Power2.easeIn }),
                                            A = new ScrollMagic.Scene({ triggerElement: h[0], triggerHook: "onLeave", duration: S }).setTween(z).addTo(a);
                                        g[w] = { type: l.blogTitle, sceneTweenPairs: [{ scene: A, tween: z }] };
                                        ...
                                        h.find(".read-more")
                                            ...
                                            .on("click.read-more", function () {
                                                var t = O() + window.innerHeight,
                                                    e = n(300, t, b);
                                                $("html, body").animate({ scrollTop: e[0] }, e[1]);
                                            });
                                        var L = h.find(".laptop-preview-sizer"),
                                            I = h.find(".header-wrapper"),
                                            D = TweenMax.to(L, 1, { scale: 0.5, ease: Power2.easeInOut }),
                                            F = TweenMax.to(I, 1, { opacity: 0, ease: Power2.easeInOut }),
                                            N = TweenMax.to(x, 1, { opacity: 0, ease: Power2.easeInOut }),
                                            j = function (t) {
                                            ...
                                            A = new ScrollMagic.Scene({ duration: O }).setTween(D).setPin(h[0]).on("end", j).addTo(a),
                                            B = new ScrollMagic.Scene({ duration: M }).setTween(F).on("end", W).addTo(a),
                                            X = new ScrollMagic.Scene({ duration: M }).setTween(N).addTo(a);
                                        g[w] = {
                                            type: l.zoomOut,
                                            sceneTweenPairs: [
                                                { scene: A, tween: D },
                                        ...
                                        H.each(function () {
                                            ...
                                            e.each(function (t) {
                                                var e = i - t,
                                                    n = (Math.round(10 * (Math.random() / 2 + 0.5)) / 10) * e;
                                                U.to(this, 1, { className: "+=g", ease: Power2.easeInOut }, n);
                                            });
                                        });
                                        var A = new ScrollMagic.Scene({ duration: C }).setTween(U).setPin(h[0]).on("end", R).addTo(a);
                                        g[w] = { type: l.phoneWall, sceneTweenPairs: [{ scene: A, tween: U, isTimeline: !0 }] };
                                        ...
                                        h.find(".read-more")
                                            ...
                                            .on("click.read-more", function (t) {
                                                ...
                                                var e = C(),
                                                    i = n(300, e, b);
                                                $("html, body").animate({ scrollTop: i[0] }, i[1]);
                                            });
                                        ...
                                        Q.on("click", function () {
                                            ...
                                            $("html, body").animate({ scrollTop: t }, n);
                                        });
                                        var z,
                                            Z = !1;
                                        G
                                            ? (z = TweenMax.to(Q, 1, { scale: 0.4, rotationX: 110, y: "-40%" }))
                                            : ((Z = !0), (z = new TimelineMax()), z.set(Q, { scale: 0.3, rotationX: 110, y: "-100%" }), z.to(Q, 1, { scale: 1, rotationX: 0, y: "0%" }), z.to(Q, 1, { scale: 0.4, rotationX: 110, y: "-40%" }));
                                        var A;
                                        (A = G ? new ScrollMagic.Scene({ duration: C }).setTween(z).addTo(a) : new ScrollMagic.Scene({ triggerElement: h[0], triggerHook: "onEnter", duration: V }).setTween(z).addTo(a)),
                                            (g[w] = { type: l.flipOut, sceneTweenPairs: [{ scene: A, tween: z, isTimeline: Z }] });
                                    } else if (h.hasClass("ga")) {
                                        h.find(".read-more")
                                            .off("click.read-more")
                                            .on("click.read-more", function (t) {
                                                var e = $(this).closest(".circle-reveal-wrapper").index(".circle-reveal-wrapper") + 1;
                                                $("html, body").animate({ scrollTop: b + window.innerHeight * e }, 800);
                                            });
                                        ...
                                        h.find(".circle-reveal-wrapper").each(function (t) {
                                            ...
                                            e.css("z-index", tt - t),
                                                J.to(n, 1, { scale: 0, ease: Power2.easeInOut }),
                                                K.to(i, 0.5, {
                                                    opacity: 0,
                                        ...
                                        var A = new ScrollMagic.Scene({ triggerElement: h[0], triggerHook: "onLeave", duration: it }).setTween(J).setPin(h[0]).addTo(a),
                                            B = new ScrollMagic.Scene({ triggerElement: h[0], triggerHook: "onLeave", duration: it })
                                                .setTween(K)
                                                .on("end", function (t) {
                                        ...
                                        g[w] = {
                                            type: l.circleReveal,
                                            sceneTweenPairs: [
                                                { scene: A, tween: J, isTimeline: !0 },
                                                { scene: B, tween: K, isTimeline: !0 },
                                            ],
                                        };
                                        ...
                                        h.find(".read-more")
                                            ...
                                            .on("click.read-more", function (t) {
                                                ...
                                                $("html, body").animate({ scrollTop: b + 2 * window.innerHeight * e }, 1200);
                                            });
                                        ...
                                        rt.each(function (t) {
                                            var e = $(this).hasClass("he") ? "right" : "left",
                                                i = { ease: Power4.easeInOut },
                                                n = { ease: Power3.easeInOut },
                                                r = { opacity: 1, ease: Power2.easeInOut, delay: 0.5 },
                                                s = { ease: Power3.easeInOut },
                                                o = { opacity: 0, ease: Power2.easeInOut },
                                                a = function (t) {
                                            ...
                                            0 === t && ot.set($(this), { zIndex: 1 }),
                                                $(this).hasClass("g") ||
                                                    ((i.left = "right" === e ? "25%" : "75%"),
                                                    (i.onStart = function () {
                                                        a(t);
                                                    }),
                                                    ...
                                                    st.to(nt, 0.8, i),
                                                    st.to({}, 0.2, {}),
                                                    ot.set($(this), { zIndex: 1 }),
                                                    (n[e] = "+=100%"),
                                                    ot.to(h, 1, n),
                                                    (r[e] = "+=50px"),
                                                    K.to(l, 0.5, r)),
                                                st.to(nt, 0.8, { left: "50%", ease: Power4.easeInOut, delay: 0.2 }),
                                                (s[e] = "-=100%"),
                                                ot.to(h, 1, s),
                                                ot.set($(this), { zIndex: -1 }),
                                                (o[e] = "-=50px"),
                                        ...
                                        var at = new ScrollMagic.Scene({ triggerElement: h[0], triggerHook: "onLeave", duration: it }).setTween(st).setPin(h[0]).addTo(a),
                                            B = new ScrollMagic.Scene({ triggerElement: h[0], triggerHook: "onLeave", duration: it }).setTween(ot).addTo(a),
                                            X = new ScrollMagic.Scene({ triggerElement: h[0], triggerHook: "onLeave", duration: it }).setTween(K).on("end", R).addTo(a);
                                        g[w] = {
                                            type: l.horizontalHalf,
                                            sceneTweenPairs: [
                                                { scene: at, tween: st, isTimeline: !0 },
                                                { scene: B, tween: ot, isTimeline: !0 },
                                                { scene: X, tween: K, isTimeline: !0 },
                                            ],
                                        };
                                    } else if (h.hasClass("fr")) {
                                        var lt = i(u, "100%"),
                                            ht = h.innerHeight() - window.innerHeight,
                                            at = new ScrollMagic.Scene({ triggerElement: h[0], triggerHook: "onLeave", duration: lt, offset: ht }).setClassToggle(h[0], "z-depth-1").setPin(h[0], { pushFollowers: !1 }).addTo(a);
                                        g[w] = { type: l.shuffleOver, sceneTweenPairs: [{ scene: at }] };
                                    } else if (h.hasClass("fn")) {
                                        var at = new ScrollMagic.Scene({ triggerElement: h[0], triggerHook: "onEnter", duration: P })
                                            .on("end", function () {
                                                h.toggleClass("shuffle-under-end");
                                            })
                                            .setClassToggle(h[0], "shuffle-under-active")
                                            .setPin(h[0], { pushFollowers: !1 })
                                            .addTo(a);
                                        g[w] = { type: l.shuffleUnder, sceneTweenPairs: [{ scene: at }] };
                                    } else if (h.hasClass("fb")) {
                                        var ut = h.find(d),
                                            ct = new TimelineMax();
                                        ut.each(function () {
                                            ct.to(this, 1, { className: "+=g", ease: Power3.easeInOut }, "-=" + f);
                                        });
                                        var at = new ScrollMagic.Scene({ triggerElement: h[0], triggerHook: "onEnter", duration: P }).setTween(ct).addTo(a);
                                        g[w] = { type: l.staggeredElement, sceneTweenPairs: [{ scene: at, tween: ct, isTimeline: !0 }] };
                                    } else if (s(h, m)) {
                                        var ft = h[0];
                                        s(h, p) && (ft = h.parent()[0]);
                                        var pt = !s(h, _),
                                            z = TweenMax.to($(this), 1, { className: "+=g", ease: Power3.easeInOut }),
                                            at = new ScrollMagic.Scene({ triggerElement: ft, triggerHook: "onEnter", duration: P, offset: 100, reverse: pt }).setTween(z).addTo(a);
                                        g[w] = { type: l.elementTransition, sceneTweenPairs: [{ scene: at, tween: z }] };
                                    }
                                } else h.attr("data-disabled", !0);
                                var dt = e(function () {
                                    var t = window.innerWidth,
                                        e = "true" === h.attr("data-disabled");
                                    if (e) window.innerWidth >= c && (h.attr("data-disabled", !1), h.scrollTransition({ reset: !1 }));
                                    else {
                                        ...
                                        "true" !== h.attr("data-disabled") && h.scrollTransition({ reset: !1 });
                                    }
                                }, 400);
                                $(window)
                                    .off("resize.scrollTransition" + w)
                                    .on("resize.scrollTransition" + w, dt);
                            }
                        });
                    },
                    destroy: function () {
            ...
            if (
                (T.length &&
                    T.imagesLoaded(function () {
                        T.masonry({ columnWidth: ".col", itemSelector: ".col" });
                    }),
    ...
    (function ($) {
        $(function () {
            $(".carousel.carousel-slider").carousel({ fullWidth: !0 }),
                ...
                $(".chips").material_chip(),
                $(".chips-initial").material_chip({ readOnly: !0, data: [{ tag: "Apple" }, { tag: "Microsoft" }, { tag: "Google" }] }),
                $(".chips-placeholder").material_chip({ placeholder: "Enter a tag", secondaryPlaceholder: "+Tag" }),
                $(".chips-autocomplete").material_chip({ autocompleteOptions: { data: { Apple: null, Microsoft: null, Google: null } } });
        });
    })(jQuery);
